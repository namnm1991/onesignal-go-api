...
type NotificationAllOf struct {
	...
	Contents StringMap `json:"contents,omitempty"`
	Headings StringMap `json:"headings,omitempty"`
	Subtitle StringMap `json:"subtitle,omitempty"`
...
// SetContents gets a reference to the given StringMap and assigns it to the Contents field.
...
// SetHeadings gets a reference to the given StringMap and assigns it to the Headings field.
...
// SetSubtitle gets a reference to the given StringMap and assigns it to the Subtitle field.
